package com.ureca.idle.originapi.presentation.web.jwt;
...
public class JwtProvider {
    ...
    public IdAndAuthority extract(String token) {
        try {
            ...
            throw new com.ureca.idle.originapi.presentation.web.jwt.JwtException("토큰의 길이 및 형식이 올바르지 않습니다.");
        } catch (ExpiredJwtException e) {
            throw new com.ureca.idle.originapi.presentation.web.jwt.JwtException("이미 만료된 토큰입니다.");
        } catch (UnsupportedJwtException e) {
            throw new com.ureca.idle.originapi.presentation.web.jwt.JwtException("지원되지 않는 토큰입니다.");
